...
from segmoe_v2.nnFormer.nnformer.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from segmoe_v2.nnFormer.nnformer.training.loss_functions.dice_loss import DC_and_CE_loss
from segmoe_v2.nnFormer.nnformer.training.network_training.network_trainer_synapse import NetworkTrainer
...
class nnFormerTrainer_synapse(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(nnFormerTrainer_synapse, self).__init__(deterministic, fp16)
